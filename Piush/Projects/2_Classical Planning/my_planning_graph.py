...
class ActionLayer(BaseActionLayer):
    ...
    def _interference(self, actionA, actionB):
        ...
        actionA_negated = set(actionA.effects) | set(actionB.preconditions)                          
        actionB_negated = set(actionB.effects) | set(actionA.preconditions)                           
        #Returns true if one actions negate the effect of the other
        if (actionA_negated & actionB_negated):
            return True
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        #raise NotImplementedError
        for aA_parent in self.parents[actionA.preconditions]:
            for aB_parent in self.parents[actionB.preconditions]:
                if self.is_mutex(aA_parent,aB_parent):
                    return True
        return False
...
class PlanningGraph:
    ...
    def h_levelsum(self):
        ...
        for goal in self.goal:
            s_levels_list = enumerate(self.literal_layers)
